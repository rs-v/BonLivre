...
public partial class LocalBookService
{
    ...
    //  - 「第N-M章」连写区间：第1-4章、第十二至十四章等——数字与单位字符之间可插入一段区间；
    //  - 装饰符号起首（☆★◆◇▲▼■●○ 等）+ 1~30 字；
    //  - ◎xxx◎、=== xxx ===、【xxx】、〖xxx〗 等包装；
